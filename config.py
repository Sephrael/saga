...
LARGE_MODEL_DEFAULT: str = "Qwen3-30B-A3B-Q4"
MEDIUM_MODEL_DEFAULT: str = "Qwen3-30B-A3B-Q4"
SMALL_MODEL_DEFAULT: str = "Qwen3-30B-A3B-Q4"
NARRATOR_MODEL_DEFAULT: str = "Qwen3-30B-A3B-Q4"
...
MAX_CHARS_FOR_PATCH_CONTEXT_WINDOW: int = 16384 # Character window for patch context

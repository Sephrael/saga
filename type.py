...
class ProblemDetail(TypedDict):
    ...
    issue_category: str # e.g., "consistency", "plot_arc", "thematic", "narrative_depth", "meta"
    problem_description: str
    quote_from_original_text: str # Verbatim quote text from the original text illustrating the problem
    quote_char_start: Optional[int] # Start character offset of the quote in the original draft
    quote_char_end: Optional[int]   # End character offset of the quote in the original draft
...
class PatchInstruction(TypedDict):
    ...
    original_problem_quote_text: str # The text of the quote that highlighted the problem

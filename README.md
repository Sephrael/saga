...
*(Your existing image of the KG - ensure the link is still valid or update it)*
![SAGA KG Visualization](https://github.com/Lanerra/saga/blob/master/SAGA-KG-6Ch.png)
